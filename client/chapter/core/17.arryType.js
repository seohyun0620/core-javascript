...
// 배열 선언
//let friends=['뽀동','또또','서현','코니'];
let friends='뽀동,또또,서현,코니'.split(',');
console.log(friends);
...
// 배열 요소 추가
let unshift=friends.unshift('멍멍');
console.log(friends);

let push=friends.push('흰둥이');
console.log('friends: ',friends);


// 배열 요소 제거
let shift=friends.shift();
console.log(shift); //제거된 값 반환
...
// 배열 복사
//참조에 의한 복사: let copiedArray=friends;
