...
for(let value of first.attributes){ //열거 가능한(iterable) 속성이기에 반복문 쓸 수 있음, 순환할려면 iterable 해야함
console.log(value);
}
...
// - elementNode.dataset
first.dataset.play='playing';//set, "data-play"가 자동으로 만들어짐
...
//first 노드 안에 data-value의 값으로 hello를 지정
//data-value라는 속성을 만들고 이 속성에 hello라는 값을 넣어줌
